...
process.env.CLOUDINARY_CLOUD_NAME = process.env.CLOUDINARY_CLOUD_NAME || 'autoparts-test';
...
process.env.PLATFORM_COMMISSION_RATE_PERCENT = process.env.PLATFORM_COMMISSION_RATE_PERCENT || '10';
